...
export const proofPayAddress = (environment === "mainnet" ? process.env.NEXT_PUBLIC_PROOFPAY_ADDRESS?.trim() : process.env.NEXT_PUBLIC_PROOFPAY_TESTNET_ADDRESS?.trim()) as `0x${string}` | undefined;
