...
const config=createConfig({ssr:true,chains:[arcChain],connectors:[injected()],transports:{5042:http(rpcUrl,{retryCount:4,retryDelay:1000,timeout:15_000}),5042002:http(process.env.NEXT_PUBLIC_ARC_TESTNET_RPC_URL || "https://rpc.testnet.arc.network",{retryCount:4,retryDelay:1000,timeout:15_000})}});
