...
export function TaskList() {
  ...
  if (!proofPayAddress) return <div className="surface rounded-xl p-6"><p className="font-semibold">Contract not configured</p><p className="mt-1 text-sm text-stone-600">Set the Testnet contract address after deployment.</p></div>;
  return <div>
